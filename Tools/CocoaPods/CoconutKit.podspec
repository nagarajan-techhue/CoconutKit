Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/nagarajan-techhue/CoconutKit'
  s.author = { 'Nagarajan' => 'nagarajan.dharmarsitha@gmail.com' }
  s.source = { :git => 'https://github.com/nagarajan-techhue/CoconutKit-CocoaPods.git', :tag => 'v#{s.version}' }
  s.platform = :ios, '4.0'
