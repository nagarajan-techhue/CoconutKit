...
+ (void)load
{
    ...
    if (! class_getInstanceMethod(self, @selector(removeFromParentViewController))) {
        s_UIViewController__parentViewController_Imp = (id (*)(id, SEL))hls_class_swizzle_selector(self,
    ...
    //        when inserted into a custom container
        ...
        s_UIViewController__isMovingToParentViewController_Imp = (BOOL (*)(id, SEL))hls_class_swizzle_selector(self,
                                                                                                               @selector(isMovingToParentViewController),
                                                                                                               (IMP)swizzled_UIViewController__isMovingToParentViewController_Imp);
        s_UIViewController__isMovingFromParentViewController_Imp = (BOOL (*)(id, SEL))hls_class_swizzle_selector(self,
                                                                                                                 @selector(isMovingFromParentViewController),
