...
+ (void)load
{
    ...
    // swizzle it as well
    s_UIPopoverController__initWithContentViewController_Imp = (id (*)(id, SEL, id))hls_class_swizzle_selector(self,
                                                                                                               @selector(initWithContentViewController:),
                                                                                                               (IMP)swizzled_UIPopoverController__initWithContentViewController_Imp);
    s_UIPopoverController__dealloc_Imp = (void (*)(id, SEL))hls_class_swizzle_selector(self,
                                                                                       @selector(dealloc),
                                                                                       (IMP)swizzled_UIPopoverController__dealloc_Imp);
    s_UIPopoverController__setContentViewController_animated_Imp = (void (*)(id, SEL, id, BOOL))hls_class_swizzle_selector(self,
