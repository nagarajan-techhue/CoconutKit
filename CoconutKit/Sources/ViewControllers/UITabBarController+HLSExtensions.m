...
+ (void)load
{
    ...
    s_UITabBarController__shouldAutorotate_Imp = (BOOL (*)(id, SEL))hls_class_swizzle_selector(self,
                                                                                               @selector(shouldAutorotate),
                                                                                               (IMP)swizzled_UITabBarController__shouldAutorotate_Imp);
    s_UITabBarController__supportedInterfaceOrientations_Imp = (NSUInteger (*)(id, SEL))hls_class_swizzle_selector(self,
                                                                                                                   @selector(supportedInterfaceOrientations),
                                                                                                                   (IMP)swizzled_UITabBarController__supportedInterfaceOrientations_Imp);
    
    // Swizzled both on iOS < 6 and iOS 6
    s_UITabBarController__shouldAutorotateToInterfaceOrientation_Imp = (BOOL (*)(id, SEL, NSInteger))hls_class_swizzle_selector(self,
